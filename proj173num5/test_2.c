...
//    Circuit* c = Circuits_partA();
//    testing_partA(c, false, false, false);
//    testing_partA(c, false, false, true);
//    testing_partA(c, false, true, false);
//    testing_partA(c, false, true, true);
//    testing_partA(c, true, false, false);
//    testing_partA(c, true, false, true);
//    testing_partA(c, true, true, false);
//    testing_partA(c, true, true, true);
//}
//
///**
